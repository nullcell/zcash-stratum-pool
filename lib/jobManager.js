...
var ExtraNonceCounter = function(configInstanceId){
    ...
    // Nonce is 32 bytes in ZCash
    var instanceId = configInstanceId || crypto.randomBytes(32).readUInt32LE(0);
...
var JobManager = module.exports = function JobManager(options){
    ...
    // Nonce is 32 bytes in ZCash
    this.extraNoncePlaceholder = new Buffer(32);
    this.extraNoncePlaceholder.write('f000000ff111111f', 'hex');
